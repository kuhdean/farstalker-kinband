...
const factionEquipment = [
    ...
    { name: 'Trophy', epCost: 1, text: "Once per battle, during a friendly operative's activation (excluding HOUND), before or after an action, if not in control range of enemy operatives, gain +1 APL until the end of its activation." }
];
