...
const factionEquipment = [
    ...
    },
    {
        ...
        rules: [
            "Once per battle, during a friendly FARSTALKER KINBAND operative's activation (excluding HOUND), before or after an action, if it's not within control range of enemy operatives, you can use this rule. If you do, add 1 to that friendly operative's APL stat until the end of its activation."
        ],
        ineligible_ids: ['hound']
    }
];
...
const universalEquipment = [
    ...
    },
    {
        name: 'Climbing Gear',
        epCost: 1,
        flavorText: 'This operative does not increase distance for climbing.',
        rules: [
